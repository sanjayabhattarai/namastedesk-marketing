...
export default function Home() {
  ...
  const handleSubmit = () => {
    setFormData({ hotelName: '', ownerName: '', phone: '', email: '', location: '', roomCount: '' });
    ...
    <div className="min-h-screen font-sans selection:bg-green-100" style={{ backgroundColor: '#F9FAFB' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="relative w-10 h-10 rounded-xl overflow-hidden shadow-inner">
               <Image src="/Namaste_desk_logo.jpg" alt="Logo" fill className="object-cover" />
            </div>
            <span className="text-xl font-bold tracking-tight text-gray-900">Namaste Desk</span>
          </div>
          <div className="hidden md:flex items-center gap-10 text-sm font-semibold text-gray-600">
            ...
            <a href="#comparison" className="hover:text-green-800 transition-colors">Why Digital?</a>
            <a href="#showcase" className="hover:text-green-800 transition-colors">Product</a>
            <a href="#demo" 
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6 leading-[1.05] tracking-tight">
            Namaste Desk: The Smart Digital Register for Your Hotel
          </h1>

          <p className="text-lg md:text-xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
            A lightweight Windows App for your laptop. Install once and manage your hotel 100% Offline. Stop the booking chaos and check-in repeat guests instantly with just their phone number, no need to ask for IDs again.
          </p>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-24 border-t border-gray-100">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Master Your Property</h2>
          <p className="text-gray-500 max-w-xl mx-auto italic">Everything you need, nothing you don't.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { 
              ...
              desc: "Don't let slow Wi-Fi stop your business. Check guests in and out even during power cuts or internet outages." 
            },
            { 
              icon: <Zap size={32} />, 
              title: "Instant Check-ins", 
              desc: "Load returning guest info by phone number. Complete registration in seconds, not minutes." 
            },
            { 
            ...
            { 
              ...
              title: "Auto Guest Cards", 
              desc: "Stop handwriting cards. Generate and print guest entry forms automatically from the system." 
            },
            { 
              icon: <ShieldCheck size={32} />, 
              title: "Local Data Privacy", 
              desc: "GDPR-compliant by design. All sensitive guest details stay on your laptop, not on a foreign server." 
            },
            { 
              icon: <Users size={32} />, 
      ...
      <section id="comparison" className="bg-gray-900 py-32">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-20">Paper vs. Namaste Desk</h2>
      ...
      <section id="showcase" className="py-24 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-gray-900 mb-4">A Digital Desk That Actually Works</h2>
            <p className="text-gray-500 text-lg">Watch how Namaste Desk transforms your daily reception work.</p>
          </div>
  ...
  <div className="md:col-span-2 mt-4">
    <button type="submit" style={{ backgroundColor: brandGreen }} className="w-full text-white font-bold py-5 rounded-2xl shadow-xl hover:scale-[1.01] active:scale-100 transition-all text-lg">
      Request My Personal Demo
        ...
        <iframe name="hidden_iframe" className="hidden" onLoad={handleIframeLoad} />
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <Image src="/Namaste_desk_logo.jpg" alt="Logo" width={32} height={32} className="rounded-lg" />
              <span className="text-xl font-bold text-gray-900">Namaste Desk</span>
            </div>
            <p className="text-gray-500 max-w-sm mb-8 leading-relaxed">
              Empowering small guest houses in Nepal and Finland to manage their property with world-class efficiency, without needing the cloud.
            </p>
            <div className="flex gap-4">
               <a href="https://wa.me/358407017910" target="_blank" rel="noreferrer" aria-label="Chat on WhatsApp" title="Chat on WhatsApp" style={{ backgroundColor: '#25D366' }} className="p-3 rounded-full text-white hover:scale-110 transition-transform">
          ...
          <div>
            <h5 className="font-bold mb-6">Market</h5>
            <ul className="space-y-4 text-gray-500 text-sm">
              <li>Nepal Hospitality</li>
              <li>Finland Majatalos</li>
              <li>Seasonal Guesthouses</li>
